...
import it.algo.theharvestar.domain.*;
...
public class HibOgmTxManager extends TxManager {
  ...
  // FIXME: remove persistence unit hardcoded dependency
  private static final EntityManagerFactory emf = Persistence.createEntityManagerFactory("theharvestar-persistence-unit");
  private static final TransactionManager transactionManager;
